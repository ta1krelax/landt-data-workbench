...
- `多电池 Stack 分层图`：每个循环指标占一层，共享圈数横轴；每个电池单独着色，并可叠加总体均值。
- 多电池模式默认设置为第 1–20 圈。点击“常用统计”可一键加入库伦效率和放电比容量，也可用“＋ 添加数据”选择其他循环汇总指标。
...
自检会解析一份 mAh 文件和一份 μAh 文件，并测试普通时序图、多电池误差棒图、Stack 图、PNG、SVG、EMF、CSV 和 XLSX 导出。
